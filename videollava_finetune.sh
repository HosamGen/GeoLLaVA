...
#SBATCH --job-name=vid_attn20 # Job name
...
# python /home/hosam.elgendy/GeoLLaVA/videollava_finetune.py --channel --model_type sample --batch_size 2 --prune_amount 0.2 --epochs 6

# Run the second script with flag
python /home/hosam.elgendy/GeoLLaVA/videollava_eval.py --model_path "./outputs/prune_chnl_20.0_Video-LLaVA-7B-hf_sample_QLORA_4bit_r64_alpha128_6epochs"
